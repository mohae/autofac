...
func ClientConfStart(builder *flatbuffers.Builder) { builder.StartObject(3) }
...
func ClientConfAddSaveInterval(builder *flatbuffers.Builder, SaveInterval int64) { builder.PrependInt64Slot(2, SaveInterval, 0) }
